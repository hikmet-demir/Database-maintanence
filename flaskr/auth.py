...
def register_customer():
    if request.method == 'POST':
        ...
        if error is None:
            ...
            db.execute(
                'INSERT INTO user (username, email, password, first_name, middle_name, last_name, phone, gender ) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
                (username, email,generate_password_hash(password), first_name, middle_name, last_name, phone, gender)
            )
            db.commit()
...
def register_customer_service_assistant():
    if request.method == 'POST':
        ...
        if error is None:
            ...
            db.execute(
                'INSERT INTO employee (id, requirement_year, department, years_of_experience) VALUES (?, ?, ?, ?)',
